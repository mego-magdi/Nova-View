...
## ✨ Features
* 🌌 **True Glassmorphism:** Translucent, alpha-blended dark acrylic interface with custom modern window controls.
* 🎯 **Cursor-Centric Zoom:** Intelligent scroll-wheel zooming that anchors precisely over your mouse pointer.
* 🖱️ **Canvas Panning:** Left-click and drag anywhere on high-resolution images to pan smoothly.
* 🖨️ **Native Print Pipeline:** Built-in high-resolution printing with automatic scaling and centering page layouts.
